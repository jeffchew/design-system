...
SLDS['__internal/chunked/docs/ui/utilities/margin/docs.mdx.js'] = (function(e) {
  function t(t) {
    for (
      var i, n, l = t[0], s = t[1], m = t[2], p = 0, d = [];
      p < l.length;
      p++
    )
      (n = l[p]),
    ...
    var i = a(0),
      ...
      f = function() {
        return Object(i.createElement)(
          ...
          m({ id: 'About-Margin' }, 'About Margin'),
          d(
            {},
          ...
          h(
            ...
            p(
              ...
              s({}, 'slds-p-'),
              ' are used for adding ',
              l({ href: '/utilities/padding' }, 'padding')
            ),
            p(
              {},
            ...
            p(
              ...
              'You can also use ',
              s({}, 'none'),
              ' as the size on any of the directions to enforce zero margin.'
            ),
            p(
              {},
              'Where ',
          ...
          m({ id: 'Variable-Density-Classes' }, 'Variable Density Classes'),
          d(
            {},
            ...
            ', we have also created variable density classes for both margin and padding. The tables below show how the values change between the Comfy and Compact settings.'
          ),
          c({ id: 'Around' }, 'Around'),
          b(
            {},
            ...
            x(
              ...
              O(
                {},
                g({}, s({}, 'slds-var-m-around_xxx-small')),
                g({}, '0.125rem'),
                g({}, '0.125rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-around_xx-small')),
                g({}, '0.25rem'),
                g({}, '0.125rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-around_x-small')),
                g({}, '0.5rem'),
                g({}, '0.125rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-around_small')),
                g({}, '0.75rem'),
                g({}, '0.25rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-around_medium')),
                g({}, '1rem'),
                g({}, '0.5rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-around_large')),
                g({}, '1.5rem'),
                g({}, '0.75rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-around_x-large')),
                g({}, '2rem'),
                g({}, '1rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-around_xx-large')),
                g({}, '3rem'),
                g({}, '1.5rem')
              )
            )
          ...
          b(
            ...
            x(
              ...
              O(
                {},
                g({}, s({}, 'slds-var-m-*_xxx-small')),
                g({}, '0.125rem'),
                g({}, '0.125rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-*_xx-small')),
                g({}, '0.25rem'),
                g({}, '0.125rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-*_x-small')),
                g({}, '0.5rem'),
                g({}, '0.25rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-*_small')),
                g({}, '0.75rem'),
                g({}, '0.5rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-*_medium')),
                g({}, '1rem'),
                g({}, '0.75rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-*_large')),
                g({}, '1.5rem'),
                g({}, '0.75rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-*_x-large')),
                g({}, '2rem'),
                g({}, '1rem')
              ),
              O(
                {},
                g({}, s({}, 'slds-var-m-*_xx-large')),
                g({}, '3rem'),
                g({}, '1.5rem')
              )
            )
