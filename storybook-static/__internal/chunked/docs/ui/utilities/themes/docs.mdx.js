...
SLDS['__internal/chunked/docs/ui/utilities/themes/docs.mdx.js'] = (function(e) {
  function t(t) {
    for (
      var n, o, s = t[0], c = t[1], u = t[2], d = 0, h = [];
      d < s.length;
      d++
    )
      (o = s[d]),
    ...
    for (i && i(t); h.length; ) h.shift()();
    return l.push.apply(l, u || []), a();
  }
  function a() {
    for (var e, t = 0; t < l.length; t++) {
      for (var a = l[t], n = !0, s = 1; s < a.length; s++) {
        var c = a[s];
        0 !== r[c] && (n = !1);
      }
    ...
    var n = a(0),
      ...
      c = [
        {
          ...
          element: r.a.createElement(
            ...
            r.a.createElement(
              ...
              null,
              'This is a ',
              r.a.createElement('strong', null, 'default'),
              ' theme and here is a',
              ' ',
              r.a.createElement('a', { href: 'javascript:void(0);' }, 'link'),
              '.'
            )
          )
        },
        ...
        },
        {
          ...
          element: r.a.createElement(
            ...
            r.a.createElement(
              ...
              null,
              'This theme has the ',
              r.a.createElement('strong', null, 'alert texture'),
      ...
      h = function() {
        return Object(n.createElement)(
          ...
          u({ id: 'About-Themes' }, 'About Themes'),
          d(
            {},
            'Use a color theme to apply color to the background and text. Some color themes apply a background image or texture.'
          ),
          u({ id: 'Base' }, 'Base'),
          Object(n.createElement)(o.a, null, Object(s.e)(c, 'default')),
          u({ id: 'Examples' }, 'Examples'),
          i({ id: 'Shade' }, 'Shade'),
          Object(n.createElement)(o.a, null, Object(s.e)(c, 'shade')),
          i({ id: 'Texture' }, 'Texture'),
          Object(n.createElement)(o.a, null, Object(s.e)(c, 'texture'))
        );
      },
      f = function() {
        return Object(l.a)(h());
