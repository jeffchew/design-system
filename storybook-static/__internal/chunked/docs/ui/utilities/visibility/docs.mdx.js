...
SLDS['__internal/chunked/docs/ui/utilities/visibility/docs.mdx.js'] = (function(
  e
) {
  function s(s) {
    for (
      var t, d, l = s[0], o = s[1], h = s[2], c = 0, m = [];
      c < l.length;
      c++
    )
      (d = l[c]),
        Object.prototype.hasOwnProperty.call(n, d) && n[d] && m.push(n[d][0]),
        (n[d] = 0);
    for (t in o) Object.prototype.hasOwnProperty.call(o, t) && (e[t] = o[t]);
    for (r && r(s); m.length; ) m.shift()();
    return a.push.apply(a, h || []), i();
  }
  function i() {
    for (var e, s = 0; s < a.length; s++) {
      for (var i = a[s], t = !0, l = 1; l < i.length; l++) {
        var o = i[l];
        0 !== n[o] && (t = !1);
      }
      t && (a.splice(s--, 1), (e = d((d.s = i[0]))));
    }
    return e;
  }
  var t = {},
  ...
  function d(s) {
    ...
    return e[s].call(i.exports, i, i.exports, d), (i.l = !0), i.exports;
  }
  (d.m = e),
    (d.c = t),
    (d.d = function(e, s, i) {
      d.o(e, s) || Object.defineProperty(e, s, { enumerable: !0, get: i });
    }),
    (d.r = function(e) {
  ...
  var l = (this.webpackJsonpSLDS___internal_chunked_docs =
    ...
    o = l.push.bind(l);
  (l.push = s), (l = l.slice());
  for (var h = 0; h < l.length; h++) s(l[h]);
  var r = o;
  return a.push([262, 0]), i();
})({
  0: function(e, s) {
    e.exports = React;
  },
    ...
    var t = i(0),
      ...
      o = [
        ...
        },
        {
          ...
          element: n.a.createElement(
            ...
            n.a.createElement(
              'div',
              { className: 'slds-is-collapsed' },
              n.a.createElement('h3', null, 'I am collapsed'),
              n.a.createElement(
                'p',
                null,
            ...
            n.a.createElement(
              'div',
              { className: 'slds-is-expanded' },
              n.a.createElement('h3', null, 'I am expanded'),
              n.a.createElement(
                'p',
                null,
        ...
        },
        {
          ...
          element: n.a.createElement(
            'div',
            { className: 'demo-only' },
            n.a.createElement('div', { className: 'slds-hide' }, 'I am hidden'),
            n.a.createElement(
              'div',
              { className: 'slds-show' },
        ...
        },
        {
          ...
          element: n.a.createElement(
            ...
            n.a.createElement(
              'div',
              { className: 'slds-transition-hide' },
              'I have zero opacity'
            ),
            n.a.createElement(
              'div',
              { className: 'slds-transition-show' },
              'I have 100% opacity'
            )
          ),
          description:
        ...
        },
        {
          ...
          element: n.a.createElement(
            'div',
            { className: 'demo-only demo-visibility' },
            n.a.createElement(
              'div',
              { className: 'slds-show_x-small' },
              'Hides on 319px and down'
            ),
            n.a.createElement(
              'div',
              { className: 'slds-hide_x-small' },
              'Hides on 320px and up'
            ),
            n.a.createElement(
              'div',
              { className: 'slds-show_small' },
              'Hides on 479px and down'
            ),
            n.a.createElement(
              'div',
              { className: 'slds-hide_small' },
            ...
            n.a.createElement(
              'div',
              { className: 'slds-show_x-large' },
              'Hides on 1279px and down'
            ),
            n.a.createElement(
              'div',
              { className: 'slds-hide_x-large' },
      ...
      S = function() {
        return Object(t.createElement)(
          ...
          c({ id: 'Assistive-Text' }, 'Assistive Text'),
          m(
            {},
            'Use the ',
          ...
          Object(t.createElement)(d.a, null, Object(l.e)(o, 'assistive-text')),
          c({ id: 'Collapsed-Expanded' }, 'Collapsed / Expanded'),
          m(
            {},
            'The ',
            h({}, '.slds-is-collapsed'),
            ' class hides the elements contained inside by controlling the height and overflow properties. Use the ',
            h({}, '.slds-is-expanded'),
          ...
          Object(t.createElement)(
            d.a,
            null,
            Object(l.e)(o, 'collapsed-expanded')
          ),
          c({ id: 'Hidden-Visible' }, 'Hidden / Visible'),
          m(
            {},
            'You can hide an element but reserve the space on the page for when the element is made visible again. To hide the element, use the  ',
            h({}, 'slds-hidden'),
            ' class. To make it visible again, use the ',
            h({}, 'slds-visible'),
            ' class.'
          ),
          m(
          ...
          Object(t.createElement)(d.a, null, Object(l.e)(o, 'hidden-visible')),
          c({ id: 'Hide-Show' }, 'Hide / Show'),
          m(
            {},
            'To hide any type of element from view and from screen readers, use the ',
            h({}, '.slds-hide'),
            ' class. Once hidden, you can display the content by using JavaScript to swap ',
            h({}, '.slds-hide'),
            ' with ',
            h({}, '.slds-show'),
            ...
            ' property to ',
            h({}, 'block'),
            '. If you need to display your hidden element as ',
            h({}, 'inline'),
            ' or ',
            h({}, 'inline-block'),
            ', you can use the ',
          ...
          Object(t.createElement)(d.a, null, Object(l.e)(o, 'hide-show')),
          c({ id: 'Transition-Hide-Show' }, 'Transition Hide / Show'),
          m(
            {},
            'To slowly transition an element from hiding and showing, use the  ',
            h({}, 'slds-transition-hide'),
            ' and ',
            h({}, 'slds-transition-show'),
            " classes . They toggle the element's opacity and also reserve its space. Note: To control the timing of the transition, add an additional ",
            h({}, 'transition'),
          ...
          Object(t.createElement)(
            d.a,
            null,
            Object(l.e)(o, 'transition-hide-show')
          ),
          c({ id: 'Responsive' }, 'Responsive'),
          m(
            {},
            'Responsive visibility classes will hide content on specific breakpoints. ',
            h({}, 'slds-show_[breakpoint]'),
            ' renders ',
            h({}, 'display: none'),
            ' when the the view port width is smaller than the breakpoint, and does nothing if it is bigger or equal. ',
            h({}, 'slds-hide_[breakpoint]'),
            ' does the opposite by rendering ',
            h({}, 'display: none'),
          ...
          Object(t.createElement)(d.a, null, Object(l.e)(o, 'responsive'))
        );
      },
      g = function() {
        return Object(a.a)(S());
