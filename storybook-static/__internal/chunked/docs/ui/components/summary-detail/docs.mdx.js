...
SLDS[
  '__internal/chunked/docs/ui/components/summary-detail/docs.mdx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, i, a = t[0], c = t[1], s = t[2], p = 0, d = [];
      p < a.length;
      p++
    )
      (i = a[p]),
      ...
      p = function() {
        return Object(r.createElement)(
          ...
          Object(r.createElement)(
            ...
            Object(a.e)(i.f, 'open-with-complex-title')
          ),
          c({ id: 'About-Summary-Detail' }, 'About Summary Detail'),
          u(
            {},
            'The summary detail component uses a button to show and hide content while showing an overall summary'
          ),
          c({ id: 'Base' }, 'Base'),
          Object(r.createElement)(l.a, { demoStyles: 'height: 150px;' }, i.e),
          c({ id: 'States' }, 'States'),
          s({ id: 'Closed' }, 'Closed'),
          Object(r.createElement)(
            l.a,
            { demoStyles: 'height: 150px;' },
            Object(a.e)(i.g, 'closed')
          ),
          c({ id: 'Examples' }, 'Examples'),
          s({ id: 'Closed-with-Complex-title' }, 'Closed with Complex title'),
          Object(r.createElement)(
            l.a,
            { demoStyles: 'height: 150px;' },
            Object(a.e)(i.f, 'closed-with-complex-title')
          ),
          s({ id: 'Open-with-Complex-title' }, 'Open with Complex title'),
          Object(r.createElement)(
            l.a,
            { demoStyles: 'height: 150px;' },
            Object(a.e)(i.f, 'open-with-complex-title')
