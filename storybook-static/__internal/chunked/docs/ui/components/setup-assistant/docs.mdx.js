...
SLDS[
  '__internal/chunked/docs/ui/components/setup-assistant/docs.mdx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, i, o = t[0], l = t[1], c = t[2], p = 0, d = [];
      p < o.length;
      p++
    )
      (i = o[p]),
  ...
  216: function(e, t, n) {
            ...
            value: function() {
              var e = this.props,
                ...
                u =
                  r &&
                  ('button' === r.type
                    ? s.a.createElement(h.a, { isOutlineBrand: !0 }, r.title)
                    : 'toggle' === r.type
    ...
    (P.propTypes = {
      ...
      action: m.a.object,
      duration: m.a.string,
      stepProgress: m.a.object,
      isActiveStep: m.a.bool
    }),
      (P.defaultProps = {
          ...
          return s.a.createElement(
            ...
            s.a.createElement(
              ...
              (n = e.action) && 'button' === n.type
                ? s.a.createElement(h.a, { isOutlineBrand: !0 }, n.title)
                : 'toggle' === n.type
                ? s.a.createElement(b.a, {
                    title: n.title,
                    isBare: !0,
    ...
    D.propTypes = { className: m.a.string };
    var H = D,
      U = n(57),
      V = [
        {
          ...
          r &&
            V.map(function(e, t) {
              return s.a.createElement(
                ...
                s.a.createElement(
                  c.a,
                  { className: p()({ 'slds-is-open': e.isOpen }) },
      ...
      J = function(e) {
        return s.a.createElement(
          ...
          s.a.createElement(
            ...
            {
              className:
                'slds-theme_shade slds-p-around_medium slds-m-bottom_small'
            },
          ...
          s.a.createElement(s.a.Fragment, null, e.children)
        );
      },
      W = a.c.a,
      Y = a.c.h2,
      ...
      X = function() {
        return Object(r.createElement)(
          ...
          Object(r.createElement)(
            i.a,
            { exampleOnly: !0 },
            Object(r.createElement)(F, { isBase: !0, stepsHaveProgress: !0 })
          ),
          Y({ id: 'About-Setup-Assistant' }, 'About Setup Assistant'),
          K(
            {},
          ...
          Object(r.createElement)(
            o.a,
            { title: 'Setup Assistant Base' },
            Object(r.createElement)(
              i.a,
              null,
              Object(r.createElement)(F, { isBase: !0 })
            )
          ),
          Y({ id: 'With-Step-Progress' }, 'With Step Progress'),
          K(
            {},
            'List of learning and task links with a recommended sequence that require progress tracking. Depending on the platform, completion checking will be through an API or a link click. The progress markers use the ',
            W({ href: '../progress-ring' }, 'Progress Ring'),
            ' component.'
          ),
          Object(r.createElement)(
            o.a,
            { title: 'Setup Assistant Base steps with Progress' },
            Object(r.createElement)(
              i.a,
              null,
              Object(r.createElement)(F, { isBase: !0, stepsHaveProgress: !0 })
          ...
          Y({ id: 'Hub-with-Expandable-Steps' }, 'Hub with Expandable Steps'),
          K(
            {},
          ...
          Object(r.createElement)(
            ...
            Object(r.createElement)(
              'p',
              null,
              "Since both the chevron toggle and the step's title act as a trigger to open and close the step's detail, ensure both the icon button and the title include",
              Object(r.createElement)('code', null, 'aria-controls=[uniqueId]'),
              ' where the ',
              Object(r.createElement)('code', null, 'uniqueId'),
              ' matches the ',
              Object(r.createElement)('code', null, 'id'),
              ' on the',
              Object(r.createElement)('code', null, '<div>'),
              ' with ',
              Object(r.createElement)(
                'code',
                null,
          ...
          Object(r.createElement)(
            o.a,
            { title: 'Setup Assistant Hub Expandable' },
            Object(r.createElement)(
              i.a,
              null,
              Object(r.createElement)(F, { stepsAreExpandable: !0 })
            )
          ),
          Y({ id: 'In-a-Card' }, 'In a Card'),
          K(
            {},
            'If the steps have associated progress, a header is added to the card containing the steps. This header indicates overall progress on this Setup Assistant and utilizes the ',
            W({ href: '../progress-bar' }, 'Descriptive Progress Bar')
          ),
          Object(r.createElement)(
            l.a,
            { type: 'a11y', header: 'Accessibility Note' },
            Object(r.createElement)(
              'p',
              null,
              'In order to prevent duplicating information for screen reader users, the percentage info on the top of the progress bar is hidden using the',
              Object(r.createElement)('code', null, 'slds-assistive-text'),
              ' class.'
            )
          ),
          Object(r.createElement)(
