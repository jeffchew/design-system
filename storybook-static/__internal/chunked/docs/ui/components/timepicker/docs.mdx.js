...
SLDS[
  '__internal/chunked/docs/ui/components/timepicker/docs.mdx.js'
] = (function(e) {
  function t(t) {
    for (
      var n, c, a = t[0], s = t[1], r = t[2], d = 0, m = [];
      d < a.length;
      d++
    )
      (c = a[d]),
        Object.prototype.hasOwnProperty.call(o, c) && o[c] && m.push(o[c][0]),
        (o[c] = 0);
  ...
  function i() {
    for (var e, t = 0; t < l.length; t++) {
      for (var i = l[t], n = !0, a = 1; a < i.length; a++) {
        var s = i[a];
        0 !== o[s] && (n = !1);
      }
      n && (l.splice(t--, 1), (e = c((c.s = i[0]))));
    }
    return e;
  }
  var n = {},
  ...
  269: function(e, t, i) {
    ...
    var n = i(0),
      ...
      r = o.a.createElement(a.a, {
        ...
        placeholder: ' ',
        listbox: o.a.createElement(s, null)
      }),
      u = [
        {
          id: 'focused',
          label: 'Focused',
          element: o.a.createElement(a.a, {
            label: 'Time',
            className: 'slds-combobox-picklist slds-timepicker',
            autocomplete: !0,
            isOpen: !0,
        ...
        },
        {
          ...
          element: o.a.createElement(a.a, {
            ...
            inputIconRightAssistiveText: !1,
            placeholder: ' ',
            listbox: o.a.createElement(s, { optionFocused: !0 }),
        ...
        },
        {
          ...
          element: o.a.createElement(a.a, {
            ...
            placeholder: ' ',
            value: '8:00am',
            listbox: o.a.createElement(s, { optionSelected: !0 })
          })
        }
      ],
      d = i(2),
      ...
      y = function() {
        return Object(n.createElement)(
          ...
          Object(n.createElement)(
            c.a,
            { exampleOnly: !0, demoStyles: 'height: 16rem;' },
            Object(d.e)(u, 'time-selection')
          ),
          b({ id: 'About-Timepicker' }, 'About Timepicker'),
          ...
          E(
            ...
            f(
              ...
              p({}, '.slds-is-open'),
              ' to the element with ',
              p({}, '.slds-dropdown-trigger'),
              ' to invoke the dropdown that contains the list of time options.'
            ),
            f(
              {},
              'The ',
          ...
          x(
            {},
            'Please follow the implementation guidelines found under ',
            m({ href: '/components/combobox' }, 'Combobox')
          ),
          b({ id: 'Base' }, 'Base'),
          Object(n.createElement)(c.a, { demoStyles: 'height: 16rem;' }, r),
          b({ id: 'States' }, 'States'),
          h({ id: 'Focused' }, 'Focused'),
          Object(n.createElement)(
            c.a,
            { demoStyles: 'height: 16rem;' },
            Object(d.e)(u, 'focused')
          ),
          h({ id: 'Open-Item-Focused' }, 'Open - Item Focused'),
          Object(n.createElement)(
            c.a,
            { demoStyles: 'height: 16rem;' },
            Object(d.e)(u, 'open-item-focused')
          ),
          h({ id: 'Open-Time-selected' }, 'Open - Time selected'),
          Object(n.createElement)(
            c.a,
            { demoStyles: 'height: 16rem;' },
            Object(d.e)(u, 'time-selection')
