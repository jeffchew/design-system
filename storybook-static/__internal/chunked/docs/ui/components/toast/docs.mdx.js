...
SLDS['__internal/chunked/docs/ui/components/toast/docs.mdx.js'] = (function(e) {
  function t(t) {
    for (
  ...
  241: function(e, t, a) {
    ...
    var s = a(0),
      ...
      h = function(e) {
        ...
        return l.a.createElement(
          'div',
          { className: u()('slds-notify_container', t) },
          l.a.createElement(
            'div',
            {
              className: u()(
    ...
    (h.propTypes = {
      ...
      type: o.a.oneOf(['info', 'success', 'warning', 'error']),
      children: o.a.node
    }),
      (h.defaultProps = { type: 'info' });
    var f = l.a.createElement(
      ...
      S = function() {
        return Object(s.createElement)(
          ...
          Object(s.createElement)(
            r.a,
            { exampleOnly: !0, demoStyles: 'height: 4rem;' },
            f
          ),
          b({ id: 'About-Toast' }, 'About Toast'),
          _({ id: 'Accessibility' }, 'Accessibility'),
          N(
            {},
            'Notifications should contain ',
            g({}, 'role="status"'),
            ' on the container to signal to assistive technology that they require the user’s attention. Historically the role of ',
            g({}, 'alert'),
            " would be used, but because you can invoke multiple toasts, assertive alerts would override previous toasts in the screen reader's speech queue. Role of ",
            g({}, 'status'),
          ...
          b({ id: 'Base' }, 'Base'),
          Object(s.createElement)(r.a, { demoStyles: 'height: 4rem;' }, f),
          b({ id: 'States' }, 'States'),
          E({ id: 'Success' }, 'Success'),
          Object(s.createElement)(
            r.a,
            { demoStyles: 'height: 4rem;' },
            Object(y.e)(p, 'success')
          ),
          E({ id: 'Warning' }, 'Warning'),
          Object(s.createElement)(
            r.a,
            { demoStyles: 'height: 4rem;' },
            Object(y.e)(p, 'warning')
          ),
          E({ id: 'Error' }, 'Error'),
          Object(s.createElement)(
            r.a,
          ...
          E({ id: 'Error-With-Details' }, 'Error With Details'),
          Object(s.createElement)(
            r.a,
            { demoStyles: 'height: 4rem;' },
            Object(y.e)(p, 'error-with-details')
          ),
          b({ id: 'Examples' }, 'Examples'),
          E({ id: 'Small-Column' }, 'Small Column'),
          Object(s.createElement)(
            r.a,
            { demoStyles: 'height: 4rem;' },
            Object(y.e)(v, 'small')
