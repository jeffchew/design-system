...
SLDS[
  '__internal/chunked/docs/ui/components/app-launcher/docs.mdx.js'
] = (function(e) {
  function t(t) {
    for (
      var l, i, o = t[0], r = t[1], c = t[2], p = 0, m = [];
      p < o.length;
      p++
    )
      (i = o[p]),
  ...
  239: function(e, t, a) {
    ...
    var l = a(0),
          ...
          s.a.createElement(
            ...
            s.a.createElement(
              ...
              s.a.createElement(
                'abbr',
                {
                  className: b()('slds-avatar__initials', e.figureClass),
                  title: e.label
                },
                e.objectInitials
              )
      ...
      T = function(e, t, a) {
        var l = e.slice(0);
        return l.splice(a, 0, l.splice(t, 1)[0]), l;
      },
      _ = E.slice(0);
    _[0] = Object.assign({}, _[0], { grabbed: !0 });
    var O = T(E, 0, 2);
    O[2] = Object.assign({}, O[2], { grabbed: !0 });
    var x = T(E, 0, 3),
      j = s.a.createElement(
        c.a,
        null,
      ...
      I = function() {
        return Object(l.createElement)(
          ...
          Object(l.createElement)(
            i.a,
            { isViewport: !0, exampleOnly: !0, demoStyles: 'height: 600px;' },
            C
          ),
          D({ id: 'About-App-Launcher' }, 'About App Launcher'),
          R(
            {},
            'The App Launcher is a ',
            k({ href: '/components/modals' }, 'modal dialog'),
            ' which contains 2 sections of information. The top section is a list of all the applications installed in the organization, and the second section is the list of items in that organization.'
          ),
          R(
            {},
            'The 2 sections are implemented as ',
            k(
              { href: '/components/expandable-section/' },
              'Expandable Sections'
            ),
            ' and can be expanded or collapsed. Applications and Items are also searchable within the modal via the search input in the modal header.'
          ),
          D({ id: 'Base' }, 'Base'),
          Object(l.createElement)(
            i.a,
            { isViewport: !0, demoStyles: Object(N.d)(w, 'default') },
            Object(N.e)(w, 'default')
          ),
          D({ id: 'Description-overflow' }, 'Description overflow'),
          R(
            {},
            'When the tile description is too long to fit on 2 lines, a "more" ',
            A({}, 'button'),
          ...
          Object(l.createElement)(
            o.a,
            { type: 'note', header: 'Truncate via JavaScript' },
            Object(l.createElement)(
              'p',
              null,
          ...
          R(
            {},
            'On hover or focus, the more ',
            A({}, 'button'),
            ' will display the full description using a ',
            k({ href: '/components/tooltips' }, 'Tooltip')
          ),
          Object(l.createElement)(
            i.a,
            { isViewport: !0, demoStyles: Object(N.d)(w, 'tooltip') },
            Object(N.e)(w, 'tooltip')
          ),
          D(
            { id: 'Reordering-tiles-via-drag-and-drop' },
            'Reordering tiles via drag and drop'
          ),
          R(
            {},
            'App tiles can be re-ordered via mouse drag and drop or with the keyboard via the use of the grab handle button under the avatar. The grab handle button is implemented as a ',
            k(
              { href: '/components/button-icons/#Stateful' },
              'Stateful Icon Button'
            )
          ),
          Object(l.createElement)(
            o.a,
            { type: 'a11y', header: 'Communicating to assistive technology' },
            Object(l.createElement)(
              'p',
              null,
              ...
              Object(l.createElement)('code', null, 'aria-live="assertive"')
            )
          ),
          M({ id: 'Tile-grabbed' }, 'Tile grabbed'),
          R(
            {},
            'When a tile is grabbed add the class name of ',
            A({}, 'slds-is-grabbed'),
            ' to the tile class list. When initiating the grab via the stateful button, be sure to set ',
            A({}, 'aria-pressed="true"'),
            ' on the button. Also be sure to update the contents of the live region to communicate what was grabbed, its current position and how to move the item. Something like: ',
            L(
              {},
              '"Sales Cloud: current position 1 of 6. Use the up and down arrows to move this app"'
            )
          ...
          Object(l.createElement)(
            i.a,
            { isViewport: !0, demoStyles: Object(N.d)(w, 'grabbed') },
            Object(N.e)(w, 'grabbed')
          ),
          M({ id: 'Tile-moved-in-list' }, 'Tile moved in list'),
          R(
            {},
            'When the tile is moved in the list using a keyboard, update the live region for every move to indicate its new position to the user. Something like: ',
            L({}, '"Sales Cloud: new position 3 of 6."')
          ),
          Object(l.createElement)(
            i.a,
            { isViewport: !0, demoStyles: Object(N.d)(w, 'moved') },
            Object(N.e)(w, 'moved')
          ),
          M({ id: 'Tile-dropped' }, 'Tile dropped'),
          R(
            {},
            'Finally, when a tile is dropped into its final position, reset ',
            A({}, 'aria-pressed'),
            ' to be ',
            A({}, 'false'),
            ' on the stateful button, and update the live region to inform the user of the items final position. e.g. ',
            L({}, '"Sales Cloud: final position 4 of 6."')
          ),
          Object(l.createElement)(
            i.a,
            { isViewport: !0, demoStyles: Object(N.d)(w, 'dropped') },
            Object(N.e)(w, 'dropped')
          ),
          D({ id: 'Searching' }, 'Searching'),
          R(
            {},
            'When using the search input at the top of the modal, the list of applications and items filters as the user types. The remaining items on display have the matching search term highlighted with the use of the ',
            A({}, '<mark />'),
            ' element wrapping the matching term. This creates the visual highlight around the term.'
          ),
          Object(l.createElement)(
            i.a,
            { isViewport: !0, demoStyles: Object(N.d)(w, 'search') },
            Object(N.e)(w, 'search')
          )
        );
      },
