...
SLDS[
  '__internal/chunked/docs/ui/components/datetime-picker/docs.mdx.js'
] = (function(e) {
  function t(t) {
    for (
      var n, o, s = t[0], r = t[1], d = t[2], m = 0, u = [];
      m < s.length;
      m++
    )
      (o = s[m]),
  ...
  function l() {
    for (var e, t = 0; t < i.length; t++) {
      for (var l = i[t], n = !0, s = 1; s < l.length; s++) {
        var r = l[s];
        0 !== a[r] && (n = !1);
      }
      n && (i.splice(t--, 1), (e = o((o.s = l[0]))));
    }
    return e;
  }
  var n = {},
    ...
    var n = l(0),
              ...
              a.a.createElement(
                ...
                a.a.createElement(
                  m.b,
                  {
                    ...
                    hasRightIcon: !0,
                    dropdown: a.a.createElement(d.b, { todayActive: !0 })
                  },
                ...
                a.a.createElement(r.a, {
                  ...
                  placeholder: ' ',
                  listbox: a.a.createElement(p, null)
                })
              )
            )
          )
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(
                      m.b,
                      {
                        ...
                        inputId: 'date-input-id',
                        hasRightIcon: !0,
                        dropdown: a.a.createElement(d.b, {
                          todayActive: !0,
                          dateSelected: 'single',
                          dateRange: 'week-4'
                        })
                ...
                a.a.createElement(
                  ...
                  a.a.createElement(
                    ...
                    a.a.createElement(r.a, {
                      ...
                      placeholder: ' ',
                      value: '8:00am',
                      listbox: a.a.createElement(p, { optionSelected: !0 })
                    })
                  )
                )
              )
      ...
      k = function() {
        return Object(n.createElement)(
          ...
          Object(n.createElement)(
            o.a,
            { exampleOnly: !0, demoStyles: 'height: 28rem;' },
            h
          ),
          E({ id: 'About-datetime-picker' }, 'About datetime picker'),
          v({ id: 'Implementation' }, 'Implementation'),
          x(
            {},
            'The datetime is two ',
            _({ href: '/components/form-element' }, 'form elements'),
            ', each containing a label and text ',
            _({ href: '/components/input' }, 'input'),
            ', and a dropdown ',
            _({ href: '/components/menus' }, 'menu'),
            ', containing a grid-based calendar and filters. The date form element acts as a trigger for the dropdown.'
          ),
          Object(n.createElement)(
            s.a,
            { type: 'warning' },
          ...
          x({}, 'The datetime picker has the following markup requirements:'),
          x({}, w({}, 'Desktop')),
          S(
            {},
            y(
              ...
              ' to invoke the dropdown that contains the datepicker and the list of time options.'
            ),
            y(
              {},
              'On the timepicker, the ',
              g({}, '.slds-has-focus'),
          ...
          S(
            ...
            y(
              {},
              'The ',
              g({}, 'input type="datetime-local"'),
              ' will create an input field allowing a date and time to be easily entered — this includes year, month, day, hours, and minutes.'
            ),
            y(
              {},
              'When switching ',
          ...
          E({ id: 'Base' }, 'Base'),
          Object(n.createElement)(o.a, { demoStyles: 'height: 28rem;' }, h),
          E({ id: 'States' }, 'States'),
          v({ id: 'Date-selection' }, 'Date selection'),
          Object(n.createElement)(
            o.a,
            { demoStyles: 'height: 28rem;' },
            Object(f.e)(b, 'date-selection')
          ),
          v({ id: 'Time-selection' }, 'Time selection'),
          Object(n.createElement)(
            o.a,
            { demoStyles: 'height: 28rem;' },
            Object(f.e)(b, 'time-selection')
          )
        );
      },
      O = function() {
