...
SLDS[
  '__internal/chunked/showcase/ui/utilities/visibility/example.jsx.js'
] = (function(e) {
  function s(s) {
    for (
      var i, l, d = s[0], o = s[1], r = s[2], c = 0, m = [];
      c < d.length;
      c++
    )
      (l = d[c]),
    ...
    for (h && h(s); m.length; ) m.shift()();
    return t.push.apply(t, r || []), n();
  }
  function n() {
    for (var e, s = 0; s < t.length; s++) {
      for (var n = t[s], i = !0, d = 1; d < n.length; d++) {
        var o = n[d];
        0 !== a[o] && (i = !1);
      }
      i && (t.splice(s--, 1), (e = l((l.s = n[0]))));
    }
    return e;
  }
  var i = {},
  ...
  function l(s) {
    ...
    return e[s].call(n.exports, n, n.exports, l), (n.l = !0), n.exports;
  }
  (l.m = e),
    (l.c = i),
    (l.d = function(e, s, n) {
      l.o(e, s) || Object.defineProperty(e, s, { enumerable: !0, get: n });
    }),
    (l.r = function(e) {
  ...
  var d = (this.webpackJsonpSLDS___internal_chunked_showcase =
    ...
    o = d.push.bind(d);
  (d.push = s), (d = d.slice());
  for (var r = 0; r < d.length; r++) s(d[r]);
  var h = o;
  return t.push([192, 0]), n();
})({
  0: function(e, s) {
    e.exports = React;
  },
      ...
      t = [
        ...
        },
        {
          ...
          element: a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement('h3', null, 'I am collapsed'),
              a.a.createElement(
                'p',
                null,
            ...
            a.a.createElement(
              ...
              a.a.createElement('h3', null, 'I am expanded'),
              a.a.createElement(
                'p',
                null,
        ...
        },
        {
          ...
          element: a.a.createElement(
            'div',
            { className: 'demo-only' },
            a.a.createElement('div', { className: 'slds-hide' }, 'I am hidden'),
            a.a.createElement(
              'div',
              { className: 'slds-show' },
