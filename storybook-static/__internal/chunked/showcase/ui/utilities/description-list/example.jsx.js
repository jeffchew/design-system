...
SLDS[
  '__internal/chunked/showcase/ui/utilities/description-list/example.jsx.js'
] = (function(e) {
  function l(l) {
    for (
      var a, s, i = l[0], d = l[1], o = l[2], _ = 0, m = [];
      _ < i.length;
      _++
    )
      (s = i[_]),
    ...
    for (c && c(l); m.length; ) m.shift()();
    return r.push.apply(r, o || []), t();
  }
  function t() {
    for (var e, l = 0; l < r.length; l++) {
      for (var t = r[l], a = !0, i = 1; i < t.length; i++) {
        var d = t[i];
        0 !== n[d] && (a = !1);
      }
      a && (r.splice(l--, 1), (e = s((s.s = t[0]))));
    }
    return e;
  }
  var a = {},
  ...
  function s(l) {
    ...
    return e[l].call(t.exports, t, t.exports, s), (t.l = !0), t.exports;
  }
  (s.m = e),
    (s.c = a),
    (s.d = function(e, l, t) {
      s.o(e, l) || Object.defineProperty(e, l, { enumerable: !0, get: t });
    }),
    (s.r = function(e) {
  ...
  var i = (this.webpackJsonpSLDS___internal_chunked_showcase =
    ...
    d = i.push.bind(i);
  (i.push = l), (i = i.slice());
  for (var o = 0; o < i.length; o++) l(i[o]);
  var c = d;
  return r.push([203, 0]), t();
})({
  0: function(e, l) {
    e.exports = React;
  },
      ...
      r = [
        {
          ...
          element: n.a.createElement(
            'dl',
            null,
            n.a.createElement('dt', null, 'First Label:'),
            n.a.createElement('dd', null, 'Description for first label'),
            n.a.createElement('dt', null, 'Second Label:'),
            n.a.createElement('dd', null, 'Description for second label')
          )
        },
        {
