...
SLDS[
  '__internal/chunked/showcase/ui/components/page-headers/base/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var n, u, l = t[0], c = t[1], i = t[2], p = 0, f = [];
      p < l.length;
      p++
    )
      (u = l[p]),
