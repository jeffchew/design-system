...
SLDS[
  '__internal/chunked/showcase/ui/components/icons/custom/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, a, c = t[0], u = t[1], i = t[2], p = 0, f = [];
      p < c.length;
      p++
    )
      (a = c[p]),
  ...
  function n() {
    for (var e, t = 0; t < s.length; t++) {
      for (var n = s[t], r = !0, c = 1; c < n.length; c++) {
        var u = n[c];
        0 !== o[u] && (r = !1);
      }
  ...
  155: function(e, t, n) {
    ...
    var r = n(0),
      ...
      u = function(e) {
        ...
        return o.a.createElement(
          'span',
          {
            className: c()('slds-icon_container slds-icon-custom-' + t),
            title: e.title || 'Description of icon when needed'
          },
          o.a.createElement(s.a, {
            className: c()('slds-icon', e.className),
            sprite: 'custom',
            symbol: t
          }),
          o.a.createElement(
    ...
    t.default = o.a.createElement(u, null);
  }
});
