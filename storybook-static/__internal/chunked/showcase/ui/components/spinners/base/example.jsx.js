...
SLDS[
  '__internal/chunked/showcase/ui/components/spinners/base/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var n, a, s = t[0], c = t[1], i = t[2], p = 0, f = [];
      p < s.length;
      p++
    )
      (a = s[p]),
  ...
  function r() {
    for (var e, t = 0; t < u.length; t++) {
      for (var r = u[t], n = !0, s = 1; s < r.length; s++) {
        var c = r[s];
        0 !== o[c] && (n = !1);
      }
