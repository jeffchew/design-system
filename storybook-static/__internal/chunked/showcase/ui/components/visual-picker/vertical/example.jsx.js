...
SLDS[
  '__internal/chunked/showcase/ui/components/visual-picker/vertical/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var s, r, i = t[0], o = t[1], c = t[2], u = 0, p = [];
      u < i.length;
      u++
    )
      (r = i[u]),
  ...
  135: function(e, t, a) {
    ...
    t.default = l.a.createElement(
      n.Fieldset,
      null,
      l.a.createElement(n.Legend, null, 'Select an option'),
      l.a.createElement(
        r.c,
        null,
        l.a.createElement(
