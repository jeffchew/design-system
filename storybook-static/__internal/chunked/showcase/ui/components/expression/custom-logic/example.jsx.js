...
SLDS[
  '__internal/chunked/showcase/ui/components/expression/custom-logic/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, a, c = t[0], i = t[1], s = t[2], p = 0, f = [];
      p < c.length;
      p++
    )
      (a = c[p]),
  ...
  168: function(e, t, n) {
    ...
    t.default = o.a.createElement(
      u.a,
      { hasCustomLogic: !0, customLogicValue: '1 OR 2', legendText: '1' },
      o.a.createElement(u.d, { legendText: '2', conditionName: 'Condition 2' })
    );
  }
});
