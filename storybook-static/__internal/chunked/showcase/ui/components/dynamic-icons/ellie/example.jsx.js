...
SLDS[
  '__internal/chunked/showcase/ui/components/dynamic-icons/ellie/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, o, s = t[0], l = t[1], c = t[2], p = 0, f = [];
      p < s.length;
      p++
    )
      (o = s[p]),
  ...
  145: function(e, t, n) {
    ...
    var r = n(0),
      a = n.n(r),
      i = n(65);
    t.default = a.a.createElement(i.a, {
