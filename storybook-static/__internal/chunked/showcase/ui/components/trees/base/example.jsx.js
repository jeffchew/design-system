...
SLDS[
  '__internal/chunked/showcase/ui/components/trees/base/example.jsx.js'
] = (function(e) {
  function a(a) {
    for (
      var l, i, c = a[0], m = a[1], o = a[2], s = 0, d = [];
      s < c.length;
      s++
    )
      (i = c[s]),
        ...
        (r[i] = 0);
    for (l in m) Object.prototype.hasOwnProperty.call(m, l) && (e[l] = m[l]);
    for (u && u(a); d.length; ) d.shift()();
    return n.push.apply(n, o || []), t();
  }
  function t() {
    for (var e, a = 0; a < n.length; a++) {
      for (var t = n[a], l = !0, c = 1; c < t.length; c++) {
        var m = t[c];
        0 !== r[m] && (l = !1);
      }
      l && (n.splice(a--, 1), (e = i((i.s = t[0]))));
    }
    return e;
  }
  var l = {},
  ...
  241: function(e, a, t) {
    ...
    function E(e, a) {
      return !a || ('object' !== s(a) && 'function' != typeof a)
        ? (function(e) {
            if (void 0 === e)
    ...
    var T = function(e) {
        ...
        return e.termToMark
          ? r.a.createElement('span', {
              dangerouslySetInnerHTML: {
                __html: ((t = a),
                (l = e.termToMark),
                t.replace(new RegExp(l, 'gi'), function(e) {
      ...
      return r.a.createElement(
        'div',
        { className: m()('slds-tree__item', e.className) },
    ...
    (T.displayName = 'TreeItem'),
      (T.propTypes = {
        children: i.a.node,
        isBranch: i.a.bool,
        isDisabled: i.a.bool,
        itemLabel: i.a.string,
        metaTextLabel: i.a.string,
        termToMark: i.a.string
      }),
      (T.defaultProps = { itemLabel: 'Tree Item' });
    var v = (function(e) {
      !(function(e, a) {
          ...
          },
          {
            ...
            value: function() {
              ...
              return r.a.createElement(
                'li',
                {
                  'aria-expanded': l ? n || !1 : null,
                  'aria-label': l ? this.getBranchAriaLabel(c, m) : null,
                  'aria-level': a,
                  'aria-selected': i,
                  role: 'treeitem',
                  tabIndex: t
    ...
    (v.displayName = 'TreeListItem'),
      (v.propTypes = {
        ariaLevel: i.a.number.isRequired,
        children: i.a.node.isRequired,
        isBranch: Object(u.b)('itemLabel', i.a.bool),
        isExpanded: Object(u.b)('isBranch', i.a.bool),
        isSelected: i.a.bool,
        itemLabel: i.a.string,
        metaTextLabel: Object(u.b)('itemLabel', i.a.string),
        tabIndex: i.a.number
      });
    var g = function(e) {
      return r.a.createElement(
    ...
    (g.displayName = 'TreeHeader'),
      (g.propTypes = { children: i.a.node, id: i.a.string.isRequired });
    var f = function(e) {
      return r.a.createElement(
        'ul',
        {
    ...
    var y = function(e) {
      return r.a.createElement('ul', { role: 'group' }, e.children);
    };
    (y.displayName = 'TreeGroup'), (y.propTypes = { children: i.a.node });
    var B = function(e) {
      return r.a.createElement(
        'div',
    ...
    (B.displayName = 'TreeContainer'), (B.propTypes = { children: i.a.node });
    var x = function() {
      return r.a.createElement(
        r.a.Fragment,
        null,
        ...
        r.a.createElement(
          ...
          r.a.createElement(T, { isBranch: !0, itemLabel: 'Tree Branch' }),
          r.a.createElement(
            y,
            null,
            r.a.createElement(v, { ariaLevel: 2 }, r.a.createElement(T, null))
          )
        ),
        r.a.createElement(
          v,
    ...
    I.displayName = 'ExpandedTree';
    var _ = function() {
      return r.a.createElement(
        r.a.Fragment,
        null,
        r.a.createElement(v, { ariaLevel: 1 }, r.a.createElement(T, null)),
        r.a.createElement(
          v,
          {
            ariaLevel: 1,
    ...
    var R = function() {
      return r.a.createElement(
        ...
        r.a.createElement(
          v,
          { ariaLevel: 1, tabIndex: 0 },
          r.a.createElement(T, { className: 'slds-is-hovered' })
        ),
        r.a.createElement(
          v,
          { ariaLevel: 1, isBranch: !0, itemLabel: 'Tree Branch' },
    ...
    R.displayName = 'TreeWithItemHovered';
    var k = function() {
      return r.a.createElement(
        r.a.Fragment,
        null,
    ...
    k.displayName = 'TreeWithItemDisabled';
    var w = t(5),
      O = t(10),
      j = t(9),
      M = ((a.default = r.a.createElement(
        B,
        null,
        r.a.createElement(g, { id: 'treeheading' }, 'Tree Group Header'),
        r.a.createElement(
          f,
          ...
          element: r.a.createElement(
            ...
            r.a.createElement(
              ...
              r.a.createElement(
                ...
                r.a.createElement(j.UtilityIcon, {
                  className:
            ...
            r.a.createElement(
              B,
              null,
              r.a.createElement(g, { id: 'treeheading' }, 'Components'),
              r.a.createElement(
                f,
                ...
                r.a.createElement(
                  ...
                  r.a.createElement(
                    ...
                    r.a.createElement(
                      ...
                      r.a.createElement(T, { itemLabel: 'lightning-button' })
                    ),
                    r.a.createElement(
                      v,
                ...
                r.a.createElement(
                  ...
                  r.a.createElement(T, { isBranch: !0, itemLabel: 'ui' }),
                  r.a.createElement(
                    y,
                    null,
                    r.a.createElement(
                      ...
                      r.a.createElement(T, { itemLabel: 'ui:button' })
                    ),
                    r.a.createElement(
                      v,
                      { ariaLevel: 2, itemLabel: 'ui:checkboxButton' },
                      r.a.createElement(T, { itemLabel: 'ui:checkboxButton' })
                    ),
                    r.a.createElement(
                      v,
                      { ariaLevel: 2, itemLabel: 'ui:radioButton' },
                      r.a.createElement(T, { itemLabel: 'ui:radioButton' })
                    )
                  )
                ),
                r.a.createElement(
