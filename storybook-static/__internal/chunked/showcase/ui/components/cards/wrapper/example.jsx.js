...
SLDS[
  '__internal/chunked/showcase/ui/components/cards/wrapper/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var n, l, c = t[0], o = t[1], d = t[2], u = 0, p = [];
      u < c.length;
      u++
    )
      (l = c[u]),
  ...
  function a() {
    for (var e, t = 0; t < s.length; t++) {
      for (var a = s[t], n = !0, c = 1; c < a.length; c++) {
        var o = a[c];
        0 !== r[o] && (n = !1);
      }
