...
SLDS[
  '__internal/chunked/showcase/ui/components/color-picker/base/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var n, l, c = t[0], u = t[1], s = t[2], p = 0, f = [];
      p < c.length;
      p++
    )
      (l = c[p]),
  ...
  227: function(e, t, r) {
    ...
    var n = r(0),
      o = r.n(n),
      a = r(44);
    t.default = o.a.createElement(a.b, null);
    var l = [
      {
        id: 'summary-error',
        label: 'Summary Error',
        element: o.a.createElement(a.b, { hasSummaryError: !0 })
      },
      {
        id: 'color-picker-open',
        label: 'Open, default tab selected',
        element: o.a.createElement(a.b, { isOpen: !0 })
      },
      {
        id: 'custom-tab-selected',
        label: 'Open, custom tab selected',
        element: o.a.createElement(a.b, { isOpen: !0, selectedTabIndex: 1 })
      },
      {
