...
SLDS[
  '__internal/chunked/showcase/ui/components/color-picker/predefined-only/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
  ...
  183: function(e, t, n) {
    ...
    var r = n(0),
      o = n.n(r),
      u = n(44);
    t.default = o.a.createElement(u.b, { hasCustom: !1 });
    var a = [
      {
        id: 'predefined-color-picker-open',
        label: 'Open',
        element: o.a.createElement(u.b, { isOpen: !0, hasCustom: !1 })
      }
    ];
  }
});
