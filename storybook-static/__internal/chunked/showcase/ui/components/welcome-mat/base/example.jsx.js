...
SLDS[
  '__internal/chunked/showcase/ui/components/welcome-mat/base/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, i, o = t[0], u = t[1], c = t[2], p = 0, f = [];
      p < o.length;
      p++
    )
      (i = o[p]),
  ...
  133: function(e, t, n) {
    ...
    var p = Object(a.f)(),
      f = [
        Object.assign({}, p[0], { completed: !0 }),
        Object.assign({}, p[1], { completed: !0 })
      ].concat(c(p.slice(2))),
      m = c(f).concat(p.slice(2)),
      d = a.a,
      b = l.a.createElement(u.Backdrop, null, l.a.createElement(i.a, null));
    t.default = b;
    var h = [
      { id: 'default', label: 'Default', demoStyles: a.e, element: b },
      {
