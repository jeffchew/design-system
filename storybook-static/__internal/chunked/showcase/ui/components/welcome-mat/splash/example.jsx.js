...
SLDS[
  '__internal/chunked/showcase/ui/components/welcome-mat/splash/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, u, l = t[0], c = t[1], i = t[2], f = 0, p = [];
      f < l.length;
      f++
    )
      (u = l[f]),
  ...
  170: function(e, t, n) {
    ...
    t.default = i;
    var s = [{ id: 'default', label: 'Default', demoStyles: u.e, element: i }];
  }
});
