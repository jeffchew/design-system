...
SLDS[
  '__internal/chunked/showcase/ui/components/welcome-mat/trailhead-connected/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, l, c = t[0], i = t[1], s = t[2], f = 0, p = [];
      f < c.length;
      f++
    )
      (l = c[f]),
  ...
  260: function(e, t, n) {
    ...
    var v = (function(e) {
      ...
      function i() {
        return d(this, i), l.apply(this, arguments);
      }
      return (
        (n = i),
        (r = [
            ...
            value: function() {
              var e = this.props,
                ...
                i = l
                  ...
                  : o.a.createElement('p', null, t, '/', n, ' units completed');
              return o.a.createElement(
                o.a.Fragment,
                null,
                o.a.createElement(
                  'h2',
                  { id: r, className: 'slds-welcome-mat__info-title' },
                ...
                o.a.createElement(
                  'div',
                  {
                    className: c()('slds-welcome-mat__info-progress', {
                      'slds-welcome-mat__info-progress_complete': l
                    })
                  },
                  o.a.createElement(
                    'div',
                    ...
                    o.a.createElement(f.ActionIcon, {
                      title: 'Completed',
                  ...
                  o.a.createElement(
                    'p',
                    null,
                    o.a.createElement('strong', null, 'Lightning Explorer')
                  ),
                  i
                ),
                l
    ...
    (v.propTypes = {
      complete: s.a.number.isRequired,
      total: s.a.number.isRequired,
      labelId: s.a.string.isRequired
    }),
      (v.defaultProps = {
        complete: 0,
        total: 5,
    ...
    var w = v,
      ...
      E = n(21),
      O = [];
    a.a.defaultProps.tiles.forEach(function(e) {
      O.push(Object.assign({}, e, { completed: !0 }));
    });
    var x = S.a,
      j = o.a.createElement(
        E.Backdrop,
        ...
        o.a.createElement(a.a, {
          content: function(e) {
            var t = e.complete,
              n = e.total,
              r = e.labelId;
            return o.a.createElement(w, { complete: t, total: n, labelId: r });
          }
        })
      ),
      P = ((t.default = j),
      [
        { id: 'default', label: 'Default', demoStyles: S.e, element: j },
        {
