...
SLDS[
  '__internal/chunked/showcase/ui/components/split-view/base/example.jsx.js'
] = (function(e) {
  function l(l) {
    for (
      var s, o, r = l[0], c = l[1], i = l[2], m = 0, u = [];
      m < r.length;
      m++
    )
      (o = r[m]),
  ...
  function t() {
    for (var e, l = 0; l < n.length; l++) {
      for (var t = n[l], s = !0, r = 1; r < t.length; r++) {
        var c = t[r];
        0 !== a[c] && (s = !1);
      }
      s && (n.splice(l--, 1), (e = o((o.s = t[0]))));
    }
    return e;
  }
  var s = {},
  ...
  function o(l) {
    ...
    return e[l].call(t.exports, t, t.exports, o), (t.l = !0), t.exports;
  }
  (o.m = e),
    (o.c = s),
    (o.d = function(e, l, t) {
  ...
  var r = (this.webpackJsonpSLDS___internal_chunked_showcase =
    ...
    c = r.push.bind(r);
  (r.push = l), (r = r.slice());
  for (var i = 0; i < r.length; i++) l(r[i]);
  var d = c;
  return n.push([222, 0]), t();
})({
  0: function(e, l) {
    e.exports = React;
  },
