...
SLDS[
  '__internal/chunked/showcase/ui/components/docked-utility-bar/base/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var l, i, r = t[0], o = t[1], c = t[2], d = 0, u = [];
      d < r.length;
      d++
    )
      (i = r[d]),
  ...
  215: function(e, t, a) {
    'use strict';
    a.r(t),
      a.d(t, 'UtilityPanel', function() {
        return m;
      }),
      a.d(t, 'UtilityBarItem', function() {
        return d;
      }),
      a.d(t, 'UtilityBar', function() {
        return u;
      }),
    ...
    var l = a(0),
      ...
      d = function(e) {
        return n.a.createElement(
          ...
          n.a.createElement(
            'button',
            {
              className: o()('slds-button slds-utility-bar__action', {
      ...
      u = function(e) {
        return n.a.createElement(
          ...
          n.a.createElement(
            'ul',
            { className: o()('slds-utility-bar', e.className) },
            e.children
          ),
          e.panel
        );
      ...
      y = n.a.createElement(
        ...
        n.a.createElement(d, { symbol: 'call' }, 'Call'),
        n.a.createElement(d, { symbol: 'clock' }, 'History'),
        n.a.createElement(d, { symbol: 'note' }, 'Notes'),
        n.a.createElement(
          d,
          { symbol: 'omni_channel' },
          n.a.createElement(
    ...
    t.default = y;
    var f = [
      { id: 'default', label: 'Default', demoStyles: c, element: y },
      {
        id: 'open',
        label: 'Panel Open',
        demoStyles: c,
        element: n.a.createElement(
          u,
          { panel: p },
          n.a.createElement(d, { symbol: 'call', active: !0 }, 'Call'),
          n.a.createElement(d, { symbol: 'clock' }, 'History'),
          n.a.createElement(d, { symbol: 'note' }, 'Notes'),
          n.a.createElement(
            d,
