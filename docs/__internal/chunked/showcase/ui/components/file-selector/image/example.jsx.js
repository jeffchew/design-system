...
SLDS[
  '__internal/chunked/showcase/ui/components/file-selector/image/example.jsx.js'
] = (function(e) {
  function r(r) {
    for (
      var l, o, s = r[0], i = r[1], c = r[2], f = 0, d = [];
      f < s.length;
      f++
    )
      (o = s[f]),
  ...
  function t() {
    for (var e, r = 0; r < n.length; r++) {
      for (var t = n[r], l = !0, s = 1; s < t.length; s++) {
        var i = t[s];
        0 !== a[i] && (l = !1);
      }
      l && (n.splice(r--, 1), (e = o((o.s = t[0]))));
    }
    return e;
  }
  var l = {},
  ...
  152: function(e, r, t) {
    ...
    var l = t(0),
      a = t.n(l),
      n = t(72);
    r.default = a.a.createElement(
      'div',
      { className: 'demo-only', style: { maxWidth: '320px' } },
      a.a.createElement(n.FileSelector, {
