...
SLDS[
  '__internal/chunked/showcase/ui/components/popovers/prompt/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var n, a, l = t[0], i = t[1], p = t[2], m = 0, d = [];
      m < l.length;
      m++
    )
      (a = l[m]),
  ...
  115: function(e, t, o) {
    'use strict';
    o.r(t),
      o.d(t, 'Footer', function() {
        return m;
      }),
      o.d(t, 'Icon', function() {
        return d;
      }),
      o.d(t, 'Prompt', function() {
        return u;
      }),
      o.d(t, 'examples', function() {
        return b;
      });
    var n = o(0),
      s = o.n(n),
      ...
      i = o(2),
      p = o.n(i),
      c = l.c.uniqueId('dialog-heading-id-'),
      m = function(e) {
      ...
      u = function(e) {
        ...
        return s.a.createElement(
          a.Popover,
          {
            className: p()('slds-popover_prompt', t, e.className),
            headingId: c,
            footer: s.a.createElement(m, {
          ...
          s.a.createElement(
            ...
            s.a.createElement(
              ...
              s.a.createElement(
                'h2',
                { id: c, className: 'slds-popover_prompt__heading' },
                'Title'
              ),
              s.a.createElement(
                'p',
    ...
    t.default = s.a.createElement(u, { symbol: 'prompt' });
    var b = [
      {
        id: 'top-left',
        label: 'Positioned: top left',
        element: s.a.createElement(u, {
          symbol: 'prompt',
          position: 'top-left'
        })
      },
      {
        ...
        element: s.a.createElement(u, { symbol: 'prompt', position: 'top' })
      },
      {
        id: 'top-right',
      ...
      },
      {
        ...
        element: s.a.createElement(u, { symbol: 'prompt', position: 'bottom' })
      },
      {
        id: 'bottom-left',
