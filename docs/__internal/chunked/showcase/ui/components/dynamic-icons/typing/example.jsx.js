...
SLDS[
  '__internal/chunked/showcase/ui/components/dynamic-icons/typing/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, a, o = t[0], u = t[1], l = t[2], p = 0, f = [];
      p < o.length;
      p++
    )
      (a = o[p]),
  ...
  193: function(e, t, n) {
    ...
    var r = n(0),
      i = n.n(r),
      s = n(68);
    t.default = i.a.createElement(s.a, {
