...
SLDS[
  '__internal/chunked/showcase/ui/components/dynamic-icons/trend/example.jsx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, i, l = t[0], o = t[1], c = t[2], d = 0, p = [];
      d < l.length;
      d++
    )
      (i = l[d]),
  ...
  function n() {
    for (var e, t = 0; t < s.length; t++) {
      for (var n = s[t], r = !0, l = 1; l < n.length; l++) {
        var o = n[l];
        0 !== a[o] && (r = !1);
      }
  ...
  251: function(e, t, n) {
    ...
    var d = function(e) {
      ...
      return a.a.createElement(
        'span',
        c({}, n, { className: o()('slds-icon-trend', e.className) }),
        a.a.createElement(
          'svg',
        ...
        a.a.createElement('span', { className: 'slds-assistive-text' }, t)
      );
    };
    d.propTypes = {
      title: i.a.string.isRequired,
      assistiveText: i.a.string.isRequired
    };
    var p = d,
      f = ((t.default = a.a.createElement(p, {
