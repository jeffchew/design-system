...
SLDS['__internal/chunked/docs/ui/utilities/position/docs.mdx.js'] = (function(
  e
) {
  function t(t) {
    for (
      var o, a, s = t[0], r = t[1], d = t[2], u = 0, p = [];
      u < s.length;
      u++
    )
      (a = s[u]),
    ...
    return l.push.apply(l, d || []), i();
  }
  function i() {
    for (var e, t = 0; t < l.length; t++) {
      for (var i = l[t], o = !0, s = 1; s < i.length; s++) {
        var r = i[s];
        0 !== n[r] && (o = !1);
      }
    ...
    var o = i(0),
      ...
      m = function() {
        return Object(o.createElement)(
          ...
          Object(o.createElement)(a.a, null, Object(s.e)(r, 'fixed')),
          u({ id: 'Absolute' }, 'Absolute'),
          p(
            {},
            d({}, '.slds-is-absolute'),
            ' can be used to position a container relative to its closest ancestor with relative positioning.'
          ),
          Object(o.createElement)(a.a, null, Object(s.e)(r, 'absolute')),
          u({ id: 'Relative' }, 'Relative'),
          p(
            {},
            d({}, '.slds-is-relative'),
          ...
          Object(o.createElement)(a.a, null, Object(s.e)(r, 'relative')),
          u({ id: 'Static' }, 'Static'),
          p(
            {},
            d({}, '.slds-is-static'),
          ...
          Object(o.createElement)(a.a, null, Object(s.e)(r, 'static'))
        );
      },
      f = function() {
        return Object(l.a)(m());
