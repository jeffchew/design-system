...
SLDS['__internal/chunked/docs/ui/utilities/line-clamp/docs.mdx.js'] = (function(
  e
) {
  function t(t) {
    for (
      var i, s, u = t[0], r = t[1], c = t[2], d = 0, o = [];
      d < u.length;
      d++
    )
      (s = u[d]),
        Object.prototype.hasOwnProperty.call(l, s) && l[s] && o.push(l[s][0]),
        (l[s] = 0);
    for (i in r) Object.prototype.hasOwnProperty.call(r, i) && (e[i] = r[i]);
    for (m && m(t); o.length; ) o.shift()();
    ...
    var i = a(0),
      ...
      c = [
        ...
        },
        {
          ...
          element: l.a.createElement(
            'div',
            { className: 'slds-line-clamp_small' },
            l.a.createElement('p', null, 'Lorem ipsum.'),
            l.a.createElement('p', null, 'dolor.'),
            l.a.createElement(
              'p',
              null,
              'Sed ut erat nec velit egestas porttitor sit amet et arcu. Aenean dui nisi, ultrices non pulvinar id, tristique vitae sapien. Sed non lacus id risus aliquam ultricies. Vestibulum accumsan nisl ante, ac aliquet erat rhoncus ac. Maecenas quam ipsum, pharetra sed tristique sed, interdum et odio. Nunc accumsan feugiat enim, vel dictum nisl egestas eu. Morbi eu elit hendrerit, sollicitudin sem a, interdum elit. Vivamus eget pharetra urna. Proin tincidunt accumsan nibh, non finibus tellus malesuada vitae. Quisque eu sodales erat, quis tempus diam. Vivamus egestas orci purus, sed efficitur ligula tincidunt at. Aliquam vel convallis ex, at lacinia quam. Pellentesque nec diam placerat, luctus enim ac, volutpat diam.'
      ...
      v = function() {
        return Object(i.createElement)(
          ...
          d({ id: 'About-Line-Clamp' }, 'About Line Clamp'),
          f(
            {},
            'When applied to text-based elements, Line Clamp allows for configurable multi-line text truncation.'
          ),
          f({}, 'SLDS supports four different line clamp limits:'),
          h(
            {},
            p(
              {},
              m({}, 'slds-line-clamp'),
              ' - truncation is determined by a token, default will truncate at 3 lines of content'
            ),
            p(
              {},
              m({}, 'slds-line-clamp_x-small'),
              ' - truncates at 2 lines of content'
            ),
            p(
              {},
              m({}, 'slds-line-clamp_small'),
              ' - truncates at 3 lines of content'
            ),
            p(
              {},
              m({}, 'slds-line-clamp_medium'),
              ' - truncates at 5 lines of content'
            ),
            p(
              {},
              m({}, 'slds-line-clamp_large'),
              ' - truncates at 7 lines of content'
            )
          ),
          Object(i.createElement)(
            u.a,
            { type: 'warning', header: 'IE11 Not Supported' },
            'The use of the ',
            Object(i.createElement)('code', null, 'line-clamp'),
            ' css property is not supported in IE11.'
          ),
          Object(i.createElement)(
            u.a,
            { type: 'warning', header: 'Not Supported on Container Elements' },
            Object(i.createElement)(
              'p',
              null,
          ...
          o({ id: 'Default' }, 'Default'),
          f(
            {},
            'The ',
            m({}, 'slds-line-clamp'),
            ' class name will truncate text after three lines. The value can be changed by reassigning a value to the ',
            m({}, 'line-clamp'),
            ' token.'
          ),
          Object(i.createElement)(
            s.a,
            { demoStyles: Object(r.d)(c, 'default') },
            Object(r.e)(c, 'default')
          ),
          o({ id: 'X-Small' }, 'X-Small'),
          f(
            {},
            'The ',
            m({}, 'slds-line-clamp_x-small'),
            ' class name will truncate text after two lines.'
          ),
          Object(i.createElement)(
            s.a,
            { style: Object(r.d)(c, 'x-small') },
            Object(r.e)(c, 'x-small')
          ),
          o({ id: 'Small' }, 'Small'),
          f(
            {},
          ...
          Object(i.createElement)(
            s.a,
            { demoStyles: Object(r.d)(c, 'medium') },
            Object(r.e)(c, 'medium')
          ),
          o({ id: 'Large' }, 'Large'),
          f(
