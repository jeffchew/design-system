...
SLDS[
  '__internal/chunked/docs/ui/components/docked-form-footer/docs.mdx.js'
] = (function(e) {
  function t(t) {
    for (
      var r, a, l = t[0], i = t[1], c = t[2], u = 0, b = [];
      u < l.length;
      u++
    )
      (a = l[u]),
  ...
  function o() {
    for (var e, t = 0; t < s.length; t++) {
      for (var o = s[t], r = !0, l = 1; l < o.length; l++) {
        var i = o[l];
        0 !== n[i] && (r = !1);
      }
      r && (s.splice(t--, 1), (e = a((a.s = o[0]))));
    }
    return e;
  }
  var r = {},
  ...
  235: function(e, t, o) {
    ...
    var r = o(0),
      ...
      c = o(34),
      d = o(69),
      u = l.c.uniqueId('dialog-heading-id-'),
      b = n.a.createElement(
        'div',
      ...
      v = function() {
        return Object(r.createElement)(
          ...
          Object(r.createElement)(
            a.a,
            { exampleOnly: !0, isViewport: !0, demoStyles: 'height: 180px;' },
            b
          ),
          m({ id: 'About-Docked-Form-footer' }, 'About Docked Form footer'),
          h({}, 'The popover should be positioned with JavaScript.'),
          h(
            {},
            'When errors are found within a form, the user will be notified with a popover with the page-level errors listed out.'
          ),
          f({ id: 'Accessibility' }, 'Accessibility'),
          h(
            {},
          ...
          Object(r.createElement)(
            a.a,
            { isViewport: !0, demoStyles: 'height: 180px;' },
            b
          ),
          f({ id: 'With-Error(s)' }, 'With Error(s)'),
          Object(r.createElement)(
            a.a,
            { isViewport: !0, demoStyles: 'height: 180px;' },
            Object(l.e)(p, 'docked-form-footer-with-error')
          ),
          f({ id: 'With-Error-Popover' }, 'With Error Popover'),
          Object(r.createElement)(
            a.a,
            { isViewport: !0, demoStyles: 'height: 180px;' },
            Object(l.e)(p, 'docked-form-footer-with-popover')
          )
        );
      },
      y = function() {
